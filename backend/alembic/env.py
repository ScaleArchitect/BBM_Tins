...
Baseline for Sprint 0: wires the engine to app settings and exposes
``Base.metadata`` as the autogenerate target. Concrete models + the first
migration (incl. RLS policies) are added in Sprint 1.
"""
